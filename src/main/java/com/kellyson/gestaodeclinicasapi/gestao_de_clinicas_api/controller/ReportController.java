...
public class ReportController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",description = "Listagem das 30 Consultas efetuada com sucesso"),
            @ApiResponse(responseCode = "404",description = "Médico não encontrado"),
            @ApiResponse(responseCode = "400",description = "Erro ao Listar as 30 Consultas do Médico, Dados invalidos na requisição"),
    })
    public ResponseEntity <List<DoctorFuture30AppointmentsDTO>> doctorFutureAppointments (
        ...
        return ResponseEntity.status(HttpStatus.OK).body(reportService.doctorFuture30Appointments(doctorId));
    }
